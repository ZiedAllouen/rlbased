...
class ViewPage extends StatefulWidget {
  const ViewPage({Key? key, required this.document,required this.id}) : super(key: key);
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            Row(
              ...
              children: [IconButton(onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (builder)=>HomefavPage()));
      }, icon:Icon(
